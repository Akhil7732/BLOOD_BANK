<script>
 ...
 Class.forName("com.mysql.jdbc.Driver");
  ...
  Statement st = con.createStatement();
    //String q="select *from n where name='name' AND password='passsword'";
     String q = "insert into acceptorn values('"+name+"','"+password+"','"+cpassword+"','"+gmail+"')";
    //ResultSet r=st.executeQuery(q);
    st.executeUpdate(q);
    response.sendRedirect("acceptor.html");
